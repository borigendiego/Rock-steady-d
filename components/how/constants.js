...
const CAROUSEL_SLIDES = [
    <div>
        ...
        <img src={'/assets/images/how-we-do-it/discover.svg'} className={'mx-auto w-16 pb-3'}/>
    ...
    <div>
        ...
        <img src={'/assets/images/how-we-do-it/innovation.svg'} className={'mx-auto w-16 pb-3'}/>
        <p className='text-center'>
   ...
   <div>
        ...
        <img src={'/assets/images/how-we-do-it/deploy.svg'} className={'mx-auto w-16 pb-3'}/>
        <p className='text-center'>
